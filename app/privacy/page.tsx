...
export default function PrivacyPage() {
  return <LegalShell title="Privacy Policy" label="Your data">
    ...
    <h2>4. Cookies and analytics</h2><p>Essential storage may keep the service secure and remember settings. Optional analytics or advertising cookies will require a consent choice where law requires it. Rejecting optional cookies will be as easy as accepting them.</p>
    <h2>5. Retention and international transfers</h2><p>We keep data only as long as needed for the purposes above, legal obligations, disputes and backups. Because LUMA can be used worldwide, data may be processed outside your country with safeguards required by applicable law.</p>
    ...
    <h2>7. Children</h2><p>LUMA is not directed to children under 13. We do not knowingly collect their personal data. Contact us if you believe a child submitted data without required consent.</p>
    <h2>8. Security</h2><p>We use reasonable organizational and technical safeguards, but no online service can promise absolute security. Report suspected issues privately to our support address.</p>
    <h2>9. Controller</h2><p>Wilds Aura / Madan Shrestha operates LUMA. Privacy requests can be sent to <a href="mailto:help@wildsaura.com">help@wildsaura.com</a>.</p>
  </LegalShell>;
}
